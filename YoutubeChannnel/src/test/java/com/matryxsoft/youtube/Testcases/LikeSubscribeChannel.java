/*Description: Play all the videos in the playlist, Like and Subscribe the channel.
...
import com.matryxsoft.youtube.Utilities.ConfigDataProvider;
...
public class LikeSubscribeChannel extends BaseClass{
	...
	public void LikeAndSubscribe(String UserId,String UserPwd, String ChannelName) throws InterruptedException
		{
